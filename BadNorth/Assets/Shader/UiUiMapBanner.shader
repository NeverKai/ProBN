			...
			Program "fp" {
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat3.xy = u_xlat3.xx * vec2(-0.5, 0.5) + vec2(0.400000006, 0.400000006);
					    ...
					    u_xlat1.xy = u_xlat1.yx * vec2(0.800000012, 0.300000012);
					    u_xlat0.xy = u_xlat0.xy / u_xlat6.xy;
					    u_xlat0.xy = clamp(u_xlat0.xy, 0.0, 1.0);
					    u_xlat2.xyz = (-vs_COLOR0.xyz) + vec3(1.0, 1.0, 1.0);
					    u_xlat1.xzw = u_xlat1.xxx * u_xlat2.xyz + vs_COLOR0.xyz;
					    u_xlat2.xyz = (-u_xlat1.xzw) + vec3(1.0, 1.0, 1.0);
					    u_xlat1.xyz = u_xlat1.yyy * u_xlat2.xyz + u_xlat1.xzw;
					    u_xlat6.x = vs_COLOR0.y + vs_COLOR0.x;
					    u_xlat6.x = u_xlat6.x + vs_COLOR0.z;
